...
import com.WindSkull.SchoolWebApp.models.entities.SchoolGradeEntity;
...
public interface SchoolGrade {
	...
	public static final NumericProperty<Integer> STUDENTID = NumericProperty.create("studentid", Integer.class);
	...
	public static final DataTarget<?> TARGET = JpaTarget.of(SchoolGradeEntity.class);
}
